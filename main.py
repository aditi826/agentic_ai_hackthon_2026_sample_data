...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print(f"  ASI:1 Key   : {'SET ✓' if ASI1_API_KEY == 'your_asi1_api_key_here' else 'NOT SET — demo mode'}")
    print(f"  Composio Key: {'SET ✓' if COMPOSIO_API_KEY == 'your_composio_api_key_here' else 'NOT SET — email simulated'}")
