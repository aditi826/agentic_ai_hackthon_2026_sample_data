...
=== TASK ===
Reason through this step by step, then return ONLY valid JSON:
{{
  "reasoning_steps": [
    "Step 1: ...",
    "Step 2: ...",
  ...
  "action_details": {{
    ...
    "supervisor_note_required": true/false,
    "notes_for_human": string or null
  }},
  "policy_ids_applied": ["POL-XXX", ...],
  "rule_violations_found": ["any policy breach found" or empty],
  "escalate": true/false,
  "escalation_reason": string or null,
  "confidence_score": float between 0.0 and 1.0,
  "human_summary": "2-3 sentence plain-English summary for a human agent"
}}"""
...
2. Clear explanation of what we're doing to resolve it
3. Timeline/next steps
4. Apology if appropriate
5. Professional sign-off from "Support Team"
